...
function WhosRightChat() {
  ...
  useEffect(() => {
    const welcomeMessage: Message = {
      id: uuidv4(),
      text: "Welcome to Who's Right! Please describe your question or debate, then tell me what each person said.",
      sender: "ai",
      timestamp: new Date(),
    };
  ...
  return (
    <div
      className="flex flex-col h-screen bg-gradient-to-br from-purple-100 to-blue-100 text-white"
      style={{
        backgroundImage:
